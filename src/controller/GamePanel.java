...
import static controller.GameManager.isQuake;
import static controller.GameManager.timer;
...
public class GamePanel extends JPanel {
        ...
        for (int i = 0 ; i < balls.size(); i ++){
            ...
            if (GameManager.ballsOnMoveNumber >= i*2) {
                ...
                if (deltaY != 0 || deltaX != 0) {
                    noMoves = false;
                }else if (ball.getX() != Ball.xLocation){
                    ball.setX(Ball.xLocation);
                }

                //check explosion
                if (isQuake) {
                    checkExplosion(ball, removingBalls, i);
                }
    ...
    private static void checkExplosion(Ball ball, ArrayList<Integer> removingBalls, int i) {
